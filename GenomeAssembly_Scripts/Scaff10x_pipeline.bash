...
#mkdir scaffdir
#ln -s /apps/scaff10x/3.1/bin/* scaffdir
#mkdir scaffdir/scaff-bin
#ln -s /apps/scaff10x/3.1/bin/* scaffdir/scaff-bin/
...
module add minimap2/2.16
minimap2 -t $PPN -ax sr $GENOME.fna $SREAD1 $SREAD2 > $GENOME.10x.sam

CURDIR=/srv/scratch/z5188231/KStuart.Starling-Aug18/Sv3.2_Starling10x/scaff
${CURDIR}/scaffdir/scaff10x -nodes $PPN -matrix 2000 -reads 8 -score 20 -longread 1 -edge 50000 -link 6 -block 50000 -sam ${CURDIR}/${GENOME}.10x.sam $GENOME.fna $SREAD1 $SREAD2 $GENOME.scaffolds.fasta 2>&1 | tee sv10x-Scaff10x.log
